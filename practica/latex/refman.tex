...
\vspace*{7cm}
\begin{center}%
{\Large Pràctica de P\+R\+O2 Primavera 2022. Circuito de torneos de tenis \\[1ex]\large v7.\+0 13-\/11-\/2017 }\\
\vspace*{1cm}
...
\input{class_conjunt___categories}
\input{class_conjunt___tornejos}
\input{class_jugador}
\input{class_partit}
\input{class_ranking}
\input{class_torneig}
\chapter{Documentació dels Fitxers}
\input{_conjunt___categories_8cc}
\input{_conjunt___categories_8hh}
\input{_conjunt___tornejos_8cc}
\input{_conjunt___tornejos_8hh}
\input{_jugador_8cc}
\input{_jugador_8hh}
\input{_partit_8cc}
\input{_partit_8hh}
